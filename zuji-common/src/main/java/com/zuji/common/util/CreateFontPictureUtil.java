 ...
 **/
public class CreateFontPictureUtil {

    private static final String TTF_PATH = "/usr/share/fonts/msyh.ttf";
     ...
     * @throws IOException
     */
    public static void generateImg(String name, File file)
            throws IOException {
        int width = 100;
        int height = 100;
        ...
        if (nameWritten.length() == 1) {
            ...
            if (isChinese(nameWritten)) {
                font = loadFont(TTF_PATH, 50);
                g2.setFont(font);
                g2.drawString(nameWritten, 25, 70);
            }
            //英文 微软雅黑
            else {
                font = loadFont(TTF_PATH, 55);
                g2.setFont(font);
